...
async def check_wallet_exists(wallet_uuid: str, session: AsyncSession) -> Wallet:
    """
...
async def check_wallet_amount(wallet_uuid: str, operation_type: SWalletUpdate, session: AsyncSession) -> Wallet:
    """
